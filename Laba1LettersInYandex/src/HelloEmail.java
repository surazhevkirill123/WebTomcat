...
public class HelloEmail {
    public static void main(String messageText,String senderAddress,String recipientAddress) throws MessagingException {
        ...
        Session session = Session.getDefaultInstance(properties,
                ...
                new Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication(senderAddress, "Ivatsevichi123");
                    }
                });
